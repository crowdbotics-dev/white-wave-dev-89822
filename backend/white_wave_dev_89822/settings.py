"""
Django settings for white_wave_dev_89822 project.
...
ROOT_URLCONF = 'white_wave_dev_89822.urls'
...
WSGI_APPLICATION = 'white_wave_dev_89822.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "white_wave_dev_89822 API",
    "DESCRIPTION": "API documentation for white_wave_dev_89822 App",
    "VERSION": "v1",
}
